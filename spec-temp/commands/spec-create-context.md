...
---
name: mg-temp:spec-create-context
...
- question: "GSD's context template has changed since mg-temp:spec-create-context was last updated. {summary of what changed and whether the command is still compatible}. How should I proceed?"
- options:
...
Usage: /mg-temp:spec-create-context <phase-number> <source-file-path>

Examples:
  /mg-temp:spec-create-context 86 docs/gaps/phase-86-gaps.md
  /mg-temp:spec-create-context 3 docs/design/auth-requirements.md
```
Exit.
