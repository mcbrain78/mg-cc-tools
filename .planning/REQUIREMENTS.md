...
- [x] **OWI-02**: The generate command detects refined templates at the project-level path and uses them when present, falling back to generic templates when no refined template exists
...
*Last updated: 2026-04-02 after Phase 24 requirement generation*
