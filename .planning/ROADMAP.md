...
| 18. Recursive Section XML Core | 0/2 | Planned | - |
...
Plans:
- [ ] 18-01-PLAN.md — TDD: recursive xml_doc.py model (build, parse, find, walk, paths, mutations) with comprehensive test suite
- [ ] 18-02-PLAN.md — Schema.md XML Schema section update with nested examples and path addressing documentation
