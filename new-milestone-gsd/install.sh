...
# ── New Milestone GSD Gate — Installer ───────────────────────────────────────
#
# Installs the mg:new-milestone-gsd command into a Claude Code configuration.
#
# Usage:
...
echo "Installing new-milestone-gsd to: ${TARGET_DIR}"
...
echo ""
echo "Invoke with:"
echo "  /mg:new-milestone-gsd [milestone name]"
echo ""
echo "Prerequisites:"
echo "  - GSD must be installed (uses /gsd:new-milestone)"
echo "  - mg:update-backlog must be installed (used for backlog refresh option)"
