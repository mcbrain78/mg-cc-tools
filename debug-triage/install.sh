...
# ── Debug Triage — Installer ─────────────────────────────────────────────────
#
# Installs the mg:debug-triage command into a Claude Code configuration.
#
# Usage:
...
echo "Installing debug-triage to: ${TARGET_DIR}"
...
echo ""
echo "Invoke with:"
echo "  /mg:debug-triage [symptom description]"
echo ""
echo "Prerequisite: GSD must be installed (uses /gsd:debug, /gsd:add-phase, etc.)"
