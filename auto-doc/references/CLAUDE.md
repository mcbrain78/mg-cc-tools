...
Reference files for the auto-doc pipeline. These are installed alongside commands and agents.

- **schema.yaml** — Data contract for all JSON artifacts (docs-scan, database-model, db-usage-index, db-table-map, verify findings, etc.)
