...
- **Paths:** `project_root`, `docs_dir_abs`, `scan_data_path`, `generate_dir`, `project_model_path`, `database_model_path`, `database_model_summary_path`, `db_table_map_path`, `notes_file`, `manifests_dir`, `scan_dir`
