...
Methodology snapshot: `/home/mcbrain/mg_projects/mg-cc-tools/.claude/commands/mg/discuss-methodology.snapshot.md`
</context>
...
1. Read the stored methodology snapshot at `/home/mcbrain/mg_projects/mg-cc-tools/.claude/commands/mg/discuss-methodology.snapshot.md`
...
<important_notes>
- The methodology snapshot at `/home/mcbrain/mg_projects/mg-cc-tools/.claude/commands/mg/discuss-methodology.snapshot.md` is the baseline this command was designed for. If drift is detected, the snapshot is NOT updated at runtime.
