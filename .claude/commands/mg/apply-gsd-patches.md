...
Each patch is a `.md` file in `/home/mcbrain/mg_projects/mg-cc-tools/.claude/gsd-patches` containing structured anchor/replace pairs. The command discovers all patches automatically, checks for idempotency, and handles conflicts gracefully.
</objective>

<context>
Target project argument: $ARGUMENTS

Patches directory: /home/mcbrain/mg_projects/mg-cc-tools/.claude/gsd-patches
Source patches directory: /home/mcbrain/mg_projects/mg-cc-tools/gsd-patches/patches
</context>
...
INSTALLED_FILES=$(cd "/home/mcbrain/mg_projects/mg-cc-tools/.claude/gsd-patches" && md5sum *.md 2>/dev/null | sort)
SOURCE_FILES=$(cd "/home/mcbrain/mg_projects/mg-cc-tools/gsd-patches/patches" && md5sum *.md 2>/dev/null | sort)
```

**If identical:** Log `Patches in sync.` and proceed to Step 1.

**If different:** Determine what changed:
- **New in source:** Files in `/home/mcbrain/mg_projects/mg-cc-tools/gsd-patches/patches` not present in `/home/mcbrain/mg_projects/mg-cc-tools/.claude/gsd-patches`
- **Modified:** Files present in both but with different checksums
- **Orphaned:** Files in `/home/mcbrain/mg_projects/mg-cc-tools/.claude/gsd-patches` not present in `/home/mcbrain/mg_projects/mg-cc-tools/gsd-patches/patches` (deleted from source)

Report:
```
--- Patch Sync Check ---

Source: /home/mcbrain/mg_projects/mg-cc-tools/gsd-patches/patches
Installed: /home/mcbrain/mg_projects/mg-cc-tools/.claude/gsd-patches
...
rm -f "/home/mcbrain/mg_projects/mg-cc-tools/.claude/gsd-patches/<orphaned-file>.md"  # for each orphaned file

# Copy all source patches to installed directory
cp "/home/mcbrain/mg_projects/mg-cc-tools/gsd-patches/patches"/*.md "/home/mcbrain/mg_projects/mg-cc-tools/.claude/gsd-patches/"
```
...
Read all `.md` files from the patches directory using Glob on `/home/mcbrain/mg_projects/mg-cc-tools/.claude/gsd-patches/*.md`.

If no patches found, report and stop:
> "No patch definitions found in `/home/mcbrain/mg_projects/mg-cc-tools/.claude/gsd-patches/`."
...
```bash
cp "/home/mcbrain/mg_projects/mg-cc-tools/.claude/gsd-patches/<modified-patch>.md" "/home/mcbrain/mg_projects/mg-cc-tools/gsd-patches/patches/<modified-patch>.md"
```
...
Synced to source: /home/mcbrain/mg_projects/mg-cc-tools/gsd-patches/patches/
...
- **Always sync modified patches back to source** — after editing any patch file in `/home/mcbrain/mg_projects/mg-cc-tools/.claude/gsd-patches`, copy it to `/home/mcbrain/mg_projects/mg-cc-tools/gsd-patches/patches` so the repo stays in sync.
