      ...
      try {
        switch (repair) {
          ...
          case 'regenerateState': {
            ...
            // GSD-LOCAL-PATCH (Bug 7): regen writes a fresh 'Status: Resuming' line; the stale
            // pre-repair file is still on disk, so bootstrap won't cover this — recompute explicitly.
            writeStateMd(statePath, stateContent, cwd, { recomputeStatus: true });
